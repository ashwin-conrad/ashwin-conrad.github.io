...
The narrative content stays in ``content/details.json`` under ``portfolio``;
this module deliberately contains presentation logic only.
"""
...
<head>
    ...
    <meta name="description" content="Ashwin Conrad is a mechanical engineering student with hands-on experience in automotive vehicle systems, manufacturing, testing, and engineering automation.">
    <meta name="theme-color" content="#17201f">
    <meta property="og:title" content="Ashwin Conrad | Mechanical Engineering & Automotive Systems">
    <meta property="og:description" content="Mechanical engineering, vehicle systems, manufacturing, and practical engineering work.">
    <meta property="og:type" content="website">
    <meta property="og:image" content="assets/photos/formula-ua27-lv-ac.jpg">
...
<body>
    ...
    <header class="site-header">
        <nav class="site-nav container" aria-label="Primary navigation">
            <a class="brand" href="#top" aria-label="Ashwin Conrad, home"><span>AC</span><i></i></a>
            <div class="nav-links">
{nav_markup}
            </div>
...
{hero_facts}
    ...
    <footer class="site-footer">
        <div class="container footer-content">
            <p>© {esc(site['year'])} Ashwin Conrad</p>
...
def render_engineering_styles() -> str:
    return r'''/* Generated by scripts/build_site.py. Edit content/details.json for content and scripts/site_renderer.py for presentation. */
