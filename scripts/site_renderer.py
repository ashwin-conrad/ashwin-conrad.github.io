...
def render_engineering_styles(design_tokens: DesignTokens) -> str:
    return r'''/* Generated by scripts/portfolio.py build. Edit content/details/design-tokens.json for visual foundations, content/details.json for content, and scripts/site_renderer.py for presentation. */
